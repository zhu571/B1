...
// Wed Mar  8 10:28:14 2023 by ROOT version 6.26/10
// from TTree tree/Geant4 data !
...
#ifdef energy_cxx
energy::energy(TTree *tree) : fChain(0) 
{
...
Int_t energy::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t energy::LoadTree(Long64_t entry)
{
...
void energy::Show(Long64_t entry)
{
...
Int_t energy::Cut(Long64_t entry)
{
